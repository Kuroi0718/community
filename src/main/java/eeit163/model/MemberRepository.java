...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	@Query(value="select myLikes from Member where id = :n ", nativeQuery = true)
	public String findMyLikes(@Param("n")Integer id);
	
	@Query(value="select record from Member where id = :n ", nativeQuery = true)
	public String findMyRecord(@Param("n")Integer id);

	@Query(value="select * from Member where id in (:n) ", nativeQuery = true)
	public List<Member> findMembersByNameArray(@Param("n")int[] idArray);
	
	@Modifying
	@Query(value="update Member set myLikes = :n where id = :m ")
	public Integer updateMyLikes(@Param("n")String str,@Param("m")Integer id);
	
	@Modifying
	@Query(value="update Member set record = :n where id = :m ")
	public Integer updateMyRecord(@Param("n")String str,@Param("m")Integer id);
	
	@Modifying
	@Query(value="update Member set purchaseHistory = :n where id = :m ")
	public void updatePurchaseHistory(@Param("n")String purchaseHistory,@Param("m")Integer id);
	
	@Query(value="select photo from Member where id = :n", nativeQuery = true)
	public byte[] getMemberPhotoById(@Param("n")Integer id);

}
/*

public void updateData(Member m)
public String updateLikePid(Member m,int pid)
public Member findMemberByID(String MemberID)
public Member findMemberByIDAndPassword(String MemberID, String password)
public byte[] findMemberPhotoByID(String mid)
 */